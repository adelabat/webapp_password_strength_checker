...
import {addObjectives, objectiveAccomplished, newPassWithScorm, startgame, resetfeedback} from './../reducers/actions';
  ...
  render(){
    return (
      <div id="container">
        ...
        <ModalProgress objectives_accomplished={this.props.password.objectives_accomplished} show={this.state.showModalProgress} handleClose={this.handleCloseModal} />
