  ...
  render() {
    ...
    return (
      <form className="form_pass" onSubmit={this.props.handleSubmit}>
              ...
              <span className={this.props.contains.letters? "bright":"dark"}>Letras</span> <span className={this.props.contains.uppercase? "bright":"dark"}>Mayúsculas</span> <span className={this.props.contains.numbers? "bright":"dark"}>Números</span> <span className={this.props.contains.special? "bright":"dark"}>Símbolos</span>
